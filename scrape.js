...
request('https://www.tnagrisnet.tn.gov.in/ARS/home/reservoir', (response, error, html) => {
    ...
    let result = {
        ...
        Dams: [
            ...
            {
                Reservoir: $('body > div.container > div > div > table > tbody > tr:nth-child(5) > td:nth-child(1)').text(),
            ...
            {
                Reservoir: $('body > div.container > div > div > table > tbody > tr:nth-child(7) > td:nth-child(1)').text(),
